...
export const UserInfo: React.FC<OpenerDetail> = (userInfo) => {
  return (
    <div className=" mx-auto px-6 pb-4 bg-white dark:bg-gray-900 shadow-md">
      ...
      <div className="flex gap-8 mt-4 text-sm text-gray-700">
        <Link to={`/${userInfo.summary.username}/following`}>
          <span className="font-semibold">
            <strong>{userInfo.following}</strong> Following
          </span>
        </Link>
        <Link to={`/${userInfo.summary.username}/followers`}>
          <span className="font-semibold">
