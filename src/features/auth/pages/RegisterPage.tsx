...
export const Register = () => {
  ...
  const onSubmit = (data: FormSchema) => {
    ...
    // Call API to register account here
  };

  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100 px-4">
      <div className="bg-white w-full max-w-md rounded-xl shadow-md p-8">
        <h2 className="text-3xl font-bold mb-6 text-center">Sign up to O</h2>
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5">
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormControl>
                    <Input type="email" placeholder="Email" {...field} className="h-12 px-4 py-3 text-base rounded-lg" />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormControl>
                    <Input type="password" placeholder="Password" {...field} className="h-12 px-4 py-3 text-base rounded-lg" />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormControl>
                    <Input type="password" placeholder="Confirm password" {...field} className="h-12 px-4 py-3 text-base rounded-lg" />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <Button type="submit" className="w-full  bg-black text-white h-12 rounded-full hover:bg-black/90 transition duration-200">
              Register
            </Button>
          </form>
        </Form>
